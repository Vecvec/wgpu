...
bitflags::bitflags! {
    ...
    pub struct ShaderStages: u32 {
        ...
        /// Binding is visible from the closest hit shader of a ray tracing pipeline
        const RAY_CLOSEST_HIT = 1 << 6;
        /// Binding is visible from the any hit shader of a ray tracing pipeline
        const RAY_ANY_HIT = 1 << 7;
        /// Binding is visible from the miss shader of a ray tracing pipeline
        const RAY_MISS = 1 << 8;
    }
}
...
bitflags::bitflags! {
    ...
    pub struct BufferUses: u16 {
        ...
        /// A buffer used to store shader binding data for a ray tracing pipeline
        const SHADER_BINDING_DATA = 1 << 15;
        /// The combination of states that a buffer may be in _at the same time_.
        const INCLUSIVE = Self::MAP_READ.bits() | Self::COPY_SRC.bits() |
            Self::INDEX.bits() | Self::VERTEX.bits() | Self::UNIFORM.bits() |
            Self::STORAGE_READ_ONLY.bits() | Self::INDIRECT.bits() | Self::BOTTOM_LEVEL_ACCELERATION_STRUCTURE_INPUT.bits() | Self::TOP_LEVEL_ACCELERATION_STRUCTURE_INPUT.bits() | Self::SHADER_BINDING_DATA.bits();
