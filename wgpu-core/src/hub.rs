...
pub struct HubReport {
    ...
    pub ray_tracing_pipeline: RegistryReport,
...
pub struct Hub {
    ...
    pub(crate) ray_tracing_pipelines: Registry<Fallible<RayTracingPipeline>>,
...
impl Hub {
    pub(crate) fn new() -> Self {
        Self {
            ...
            ray_tracing_pipelines: Registry::new(),
    ...
    pub fn generate_report(&self) -> HubReport {
        HubReport {
            ...
            ray_tracing_pipeline: self.ray_tracing_pipelines.generate_report(),
